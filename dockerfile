...
ENV NEXT_PUBLIC_WEBAPP_URL=http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER \
    ...
    NEXT_PUBLIC_APP_NAME=NEXT_PUBLIC_APP_NAME_PLACEHOLDER \
    NEXT_PUBLIC_COMPANY_NAME=NEXT_PUBLIC_COMPANY_NAME_PLACEHOLDER \
    NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS=NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS_PLACEHOLDER \
    NEXT_PUBLIC_SENDGRID_SENDER_NAME=NEXT_PUBLIC_SENDER_NAME_PLACEHOLDER \
    NEXT_PUBLIC_SENDER_ID=NEXT_PUBLIC_SENDER_ID_PLACEHOLDER \
    NEXT_PUBLIC_WEBSITE_URL=NEXT_PUBLIC_WEBSITE_URL_PLACEHOLDER
